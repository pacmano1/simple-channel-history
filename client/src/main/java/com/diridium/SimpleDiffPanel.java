...
public class SimpleDiffPanel extends JPanel {
    ...
    private void displayDiff(String leftContent, String rightContent) {
        List<String> leftLines = Arrays.asList(leftContent.split("\n", -1));
        List<String> rightLines = Arrays.asList(rightContent.split("\n", -1));
        ...
        try {
            ...
            for (AbstractDelta<String> delta : patch.getDeltas()) {
                ...
                switch (delta.getType()) {
                    ...
                    case CHANGE:
                        // Lines changed - show old on left, new on right
